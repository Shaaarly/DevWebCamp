<header class="header">
    <div class="header__contenedor">
        ...
        <div class="header__contenido">
            ...
            <p class="header__texto header__textoheader__texto--modalidad">En Linea - Presencial</p>
...
<div class="barra">
    <div class="barra__contenido">
        ...
        <nav class="navegacion">
            ...
            <a href="/workshops-conferencias" class="navegacion__enlace <?php echo paginaActual('/workshops') ? 'navegacion__enlace--actual' : ''; ?>">Workshops / Conferencias</a>
