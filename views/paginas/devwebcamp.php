<main class="devwebcamp">
    ...
    <div class="devwebcamp__grid">
        ...
        <div class="devwebcamp__contenido">
            <p class="devwebcamp__texto"> Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur lacus est, volutpat sit amet efficitur quis, sollicitudin non lorem. Vestibulum orci felis, sagittis vel lacus quis, pellentesque pretium diam. Duis bibendum pharetra aliquet.</p>
